...
$conn = mysqli_connect('localhost','protus','protus@254','contact_db') or die('connection failed');
...
if(isset($_POST['send'])){
    ...
    } else{mysqli_query($conn, "INSERT INTO `contact_tb`(name, email, number, message) VALUES ('$name', '$email', '$number', '$msg')") or die('query failed');
...
<section class="about" id="about">
    ...
    <div class="biography">
        ...
        <a href="./files/PROTUS CVT.pdf" class="btn" data-aos="fade-up">download CV</a>
...
<div class="credit"> &copy; copyright @ <?php echo date('Y'); ?> <br> by <span>Protus Sang'</span></div>
